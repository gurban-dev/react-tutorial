...
React only takes care of rendering the view and making sure that the view is in sync with the state.

"state" is the data displayed when a component is rendered.
...
React strict code executes useEffect() an additional time to catch bugs.
